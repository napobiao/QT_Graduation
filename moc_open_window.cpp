...
const QMetaObject Open_Window::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Open_Window.data,
      qt_meta_data_Open_Window,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Open_Window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Open_Window.stringdata0))
        return static_cast<void*>(const_cast< Open_Window*>(this));
